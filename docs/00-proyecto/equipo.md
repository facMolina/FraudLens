...
> Fuente: planilla `TIF_2C2026_Clase1597_Britez.xlsx`. Orden alfabético por apellido, tal como fue cargado.
...
Rotación de presentadores (se completa a medida que avanzamos):

| Instancia | Fecha | Presenta |
|---|---|---|
| Sprint Review 1 | ⬜ | ⬜ |
| Sprint Review 2 | ⬜ | ⬜ |
| Sprint Review 3 | ⬜ | ⬜ |
...
Somos un equipo: la nota, la entrega y el pitch son colectivos.
