...
| 3 | Autenticación + roles (admin vs analista) están **dentro** del alcance | ¿Es necesario para demostrar valor, o es NO MVP? | ✅ **Resuelto (2026-09-14):** el Analista hace las dos cosas — revisa casos (CU-05/CU-06) y ve los reportes/señales del sistema. No hace falta un rol ni login distinto para el Administrador en el MVP. Ver [decisión 0005](../03-decisiones/0005-recorte-alcance-mvp.md) |
